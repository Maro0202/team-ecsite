...
import jp.co.internous.dandelion.model.domain.MstDestination;
import jp.co.internous.dandelion.model.domain.MstUser;
import jp.co.internous.dandelion.model.form.DestinationForm;
import jp.co.internous.dandelion.model.mapper.MstDestinationMapper;
import jp.co.internous.dandelion.model.mapper.MstUserMapper;
import jp.co.internous.dandelion.model.session.LoginSession;

@Controller
@RequestMapping("/dandelion/destination")
